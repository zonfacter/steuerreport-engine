...
Generiert: `2026-05-09T20:51:28.274408+00:00`
JSON: `var/chronological_balance_break_audit_after_binance_btc_vet_win_reconstruction_2026-05-09.json`
...
- Endbestand Modell: `14135.69450151`
- Events: `5`
- Erster Negativbestand: `` nach ``
- Auslösend: `` / `` / `` / ``
- Schlimmster Stand: `14135.69450151` am `2023-05-02T04:12:36+00:00`
...
- `binance_btc_2023_vet_win_blockpit_reconstruction` / `trade` / `buy_quote`: `-14156.61280211`
- `binance_btc_2023_vet_win_blockpit_reconstruction` / `internal_balance_adjustment` / `in`: `14149.30730362`
...
- Endbestand Modell: `1706.98022349101011250000`
- Events: `2062`
...
- Endbestand Modell: `1577.92535200143114379127906`
- Events: `27535`
- Erster Negativbestand: `` nach ``
- Auslösend: `` / `` / `` / ``
...
Top Quellen-Netto:
- `binance_btc_2023_vet_win_blockpit_reconstruction` / `internal_balance_adjustment` / `in`: `100.01639287`
- `binance_btc_2023_vet_win_blockpit_reconstruction` / `trade` / `buy_quote`: `-100.01639287`
...
- Endbestand Modell: `0.00264023400000000000`
- Events: `70`
- Erster Negativbestand: `` nach ``
- Auslösend: `` / `` / `` / ``
