...
Erstellt: `2026-05-08T06:56:25.789019+00:00`
...
- `2025-06-01`: `54` Events, Derivate `12`, Referenz `29`, Primaer `25`, Failed-Solana-0 `1`, Flags: reference_dominated, failed_zero_solana_tx, suspicious_reward_unit
- `2025-02-20`: `54` Events, Derivate `54`, Referenz `30`, Primaer `24`, Failed-Solana-0 `0`, Flags: derivative_dominated, reference_dominated, many_zero_quantity_events, timestamp_cluster
- `2025-01-28`: `46` Events, Derivate `0`, Referenz `46`, Primaer `0`, Failed-Solana-0 `0`, Flags: reference_dominated
- `2025-05-29`: `44` Events, Derivate `44`, Referenz `44`, Primaer `0`, Failed-Solana-0 `0`, Flags: derivative_dominated, reference_dominated
- `2025-02-25`: `41` Events, Derivate `37`, Referenz `26`, Primaer `15`, Failed-Solana-0 `0`, Flags: derivative_dominated, reference_dominated
