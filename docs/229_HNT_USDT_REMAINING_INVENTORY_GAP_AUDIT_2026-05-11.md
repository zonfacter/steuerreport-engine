...
- Nicht gematchte Self-Transfer-Kandidaten mit gleicher Helium-Transaktion: `0`

| Zeit | Out-Quelle | In-Quelle | Delta HNT | Match vorhanden |
| --- | --- | --- | ---: | --- |
| `2021-06-24T04:41:04+00:00` | `helium_legacy_cointracking` | `helium_legacy_raw` | 0.02936241610739 | ja |
| `2021-06-24T07:22:47+00:00` | `helium_legacy_cointracking` | `helium_legacy_raw` | 0.02983692839904 | ja |
| `2021-08-14T17:15:46+00:00` | `helium_legacy_cointracking` | `helium_legacy_raw` | 0.02125658612546 | ja |
| `2022-01-27T19:08:34+00:00` | `helium_legacy_cointracking` | `helium_legacy_raw` | 0.012350797949765 | ja |
| `2022-02-02T19:01:33+00:00` | `helium_legacy_cointracking` | `helium_legacy_raw` | 0.013539651837524 | ja |
| `2022-03-04T06:24:58+00:00` | `helium_legacy_cointracking` | `helium_legacy_raw` | 0.01565995525727 | ja |
| `2022-05-02T05:12:04+00:00` | `helium_legacy_cointracking` | `helium_legacy_raw` | 0.02566584535961 | ja |
| `2022-07-12T04:07:22+00:00` | `helium_legacy_raw` | `helium_legacy_cointracking` | 0 | ja |
| `2022-12-31T21:57:55+00:00` | `helium_legacy_raw` | `helium_legacy_cointracking` | 0 | ja |
