...
Generiert: `2026-05-09T19:29:33.728512+00:00`
JSON: `var/chronological_balance_break_audit_after_binance_duplicate_deposit_cleanup_2026-05-09.json`
...
- Endbestand Modell: `35710.35144520999993000000`
- Events: `1352`
- Erster Negativbestand: `2025-01-19T22:39:56.226000+00:00` nach `02f69cc37d836a1575a64933a5443660380ce0d32d06ad45ab9622abe7eb9ccf`
- Auslösend: `binance_api` / `trade` / `sell_base` / `-7.20000000`
- Schlimmster Stand: `-8426.76242220000007000000` am `2025-01-28T05:41:05.059000+00:00`
...
- Schlimmster Stand: `-125.52609184620000200000` am `2022-01-19T12:56:19+00:00`
...
- Endbestand Modell: `2479.31356815143114379127906`
- Events: `27597`
- Erster Negativbestand: `` nach ``
- Auslösend: `` / `` / `` / ``
...
Jahres-Netto:
- `2021`: `1096.04556561362897023903392`
- `2022`: `773.62718020921237215284314`
...
- Endbestand Modell: `379.48321450400000000000`
- Events: `2034`
- Erster Negativbestand: `` nach ``
- Auslösend: `` / `` / `` / ``
...
- `blockpit` / `trade` / `out`: `-51.824433138`
...
- Erster Negativbestand: `` nach ``
- Auslösend: `` / `` / `` / ``
- Schlimmster Stand: `4.8492138` am `2025-07-11T20:09:15+00:00`
