...
Generiert: `2026-05-09T14:32:32.473333+00:00`
JSON: `var/chronological_balance_break_audit_after_binance_dust_reference_exclusions_2026-05-09.json`
...
- Endbestand Modell: `2522892.1320230`
- Events: `3066`
- Erster Negativbestand: `` nach ``
- Auslösend: `` / `` / `` / ``
...
- Endbestand Modell: `2681.67191191143114379127906`
- Events: `27751`
- Erster Negativbestand: `` nach ``
- Auslösend: `` / `` / `` / ``
...
- `blockpit` / `withdrawal` / `out`: `-1997.84776638`
...
- Endbestand Modell: `690.12033045396508054000`
- Events: `5037`
