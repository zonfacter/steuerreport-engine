#!/usr/bin/env python3
"""Import missing Binance transaction-history ledger rows for the Feb/Mar 2022 Pionex funding gap."""
...
SOURCE_NAME = "binance_transaction_history_feb2022_gap_2026-05-08"
JSON_OUT = ROOT / "var" / "binance_transaction_history_feb2022_gap_import_2026-05-08.json"
MD_OUT = ROOT / "docs" / "69_BINANCE_TRANSACTION_HISTORY_FEB2022_GAP_IMPORT_2026-05-08.md"
...
def main() -> None:
    ...
    payload = {
        ...
        "rows": rows,
        "note": "Narrow import of transaction-ledger rows only; withdrawals/deposits and Earn movements are intentionally excluded.",
    }
...
def build_rows() -> list[dict[str, Any]]:
    ...
    # UTC+2 file timestamps. Start after the already imported Jan-2022 gap and end after the Feb 25 HNT sells,
    # before any later unrelated periods.
    start_local = pd.Timestamp("2022-01-19 14:52:45")
    end_local = pd.Timestamp("2022-02-26 00:00:00")
        ...
        out.append(
            {
                ...
                "tx_id": f"binance-txhist-feb2022:{time_key}:{idx}:{operation}:{coin}",
                "source": "binance",
                "raw_row": {
                    ...
                    "import_scope": "feb2022_gap_before_pionex_march_break",
                },
            }
        )
